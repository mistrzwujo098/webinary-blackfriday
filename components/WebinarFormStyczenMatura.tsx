...
export default function WebinarFormStyczenMatura() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Tracking Lead Event
      tracking.lead(email, 'Webinar Styczeń vs Marzec Matura')
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base text-gray-600 mb-6 max-w-md mx-auto">
              ...
              i co możesz z tym zrobić przed maturą.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
              <div className="inline-flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-full text-sm font-semibold">
                ...
                <span>Już 623 maturzystów się zapisało</span>
              </div>

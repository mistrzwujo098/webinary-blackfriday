    ...
    <footer className="bg-paulina-primary text-white py-8 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex justify-center gap-6 text-sm mt-4">
          ...
          <a href="https://paulinaodmatematyki.com/polityka-prywatnosci" className="hover:text-paulina-accent transition-colors" target="_blank" rel="noopener noreferrer">Polityka prywatnosci</a>
        </div>
        <div className="mt-6 pt-6 border-t border-white/20 text-sm text-gray-300">
          <p>&copy; 2026 Paulina od Matematyki. Wszystkie prawa zastrzeżone.</p>
        </div>
      </div>
    </footer>
  )

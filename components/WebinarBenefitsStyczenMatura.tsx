...
export default function WebinarBenefitsStyczenMatura() {
  ...
  const benefits: Benefit[] = [
    ...
    },
    {
      ...
      title: 'Które działy dają najwięcej punktów',
      description: 'Dowiesz się na czym skupić się w pierwszej kolejności, żeby zdobyć maksimum punktów przy minimalnym wysiłku.'
    },
    {
      icon: <Brain className="w-7 h-7" />,
      title: 'Plan dla Twojego poziomu',
      description: 'Czy celujesz w 30% czy 80% — pokażę co realistycznie możesz osiągnąć. Bez obietnic cudów, z konkretnym harmonogramem.'
    }
  ]
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-paulina-bg-purple to-white">
      <div className="max-w-5xl mx-auto">
        ...
        >
          Konkretne informacje, które pomogą Ci zaplanować przygotowania do matury:
        </motion.p>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              'Masz maturę z matematyki w maju',
